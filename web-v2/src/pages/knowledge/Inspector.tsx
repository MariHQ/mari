      ...
      <div className="inspector__body">
        ...
        {insTab === "INSPECTOR" ? (
          ...
          <>
            ...
            <h5>Summary</h5>
            <p style={{ margin: 0, font: "14px/1.55 var(--serif)", color: "#10263b" }}>{insp.summary}</p>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1.1fr 1fr", gap: 16 }}>
              ...
              <div>
                ...
                <svg viewBox="0 0 150 96" width="100%" aria-hidden style={{ background: "var(--card-inner)", borderRadius: 8, border: "1px solid var(--line-soft)" }}>
                  <g stroke="#939da7" strokeWidth="1.3" strokeDasharray="3 4">
                  ...
                  <g>
                    <rect x="61" y="12" width="28" height="26" rx="6" fill="#ffffff" stroke="#10263b" strokeWidth="1.2" />
                    ...
                    {(["github", "slack", "notion"] as const).map((s, i) => (
                      <g key={s}>
                        <rect x={23 + i * 38} y={62} width="26" height="24" rx="6" fill="#ffffff" stroke="#d6dbe1" strokeWidth="1.1" />
