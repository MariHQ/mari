...
export const THEMES = [
  { key: "mari", name: "Mari Editorial", accent: "#1c3f60", bg: "#ffffff" },
  { key: "minimal", name: "Minimal", accent: "#10263b", bg: "#ffffff" },
  { key: "material", name: "Material", accent: "#35549d", bg: "#f8f9fc" },
  { key: "starlight", name: "Starlight", accent: "#43663c", bg: "#fbfaf6" },
];

export const ACCENTS = ["#1c3f60", "#35549d", "#43663c", "#6a5a9c", "#a05e1c"];
...
export const relDot = (status: string) =>
  status === "live" ? "var(--green)" : status === "rolled_back" ? "var(--gold)" : "#939da7";
