...
const COLOR_FIELDS: { key: ColorKey; label: string; hint: string }[] = [
  { key: "accent", label: "Accent", hint: "Primary buttons, links, and the active nav indicator." },
    ...
    <>
                ...
                <span className="row" style={{ gap: 8, flexWrap: "wrap" }}>
                  {evidence.fonts.map((f) => (
                    <Chip
                      ...
                      onClick={() => patch({ displayFont: `"${f}", "Inter", "Helvetica Neue", Arial, sans-serif` })}
                    >
                      {f}
                    </Chip>
                  ))}
      ...
      >
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 14, marginTop: 14 }}>
          <Field label="Display font" hint="Family for headings (--display). Empty = Inter.">
            <Input
          ...
          <Field label="Body font" hint="Family for body prose (--serif). Empty = Inter.">
            <Input
              placeholder='"Inter", "Helvetica Neue", Arial, sans-serif'
