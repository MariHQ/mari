...
import { TexturePlaceholder } from "../components/art";
...
const TOKENS: { name: string; varName: string; hex: string }[] = [
  ...
  { name: "Paper deep / Flysch", varName: "--paper-deep", hex: "#f0f2f5" },
  { name: "Card", varName: "--card", hex: "#ffffff" },
  { name: "Card inner", varName: "--card-inner", hex: "#f0f2f5" },
  { name: "Line", varName: "--line", hex: "#d6dbe1" },
  { name: "Ink", varName: "--ink", hex: "#10263b" },
  { name: "Ink soft", varName: "--ink-soft", hex: "#6f7c89" },
  { name: "Ink faint", varName: "--ink-faint", hex: "#939da7" },
  { name: "Biscay", varName: "--terra", hex: "#1c3f60" },
  { name: "Moss", varName: "--green", hex: "#2c6e49" },
  { name: "Biscay-2", varName: "--blue", hex: "#1e6fa8" },
  { name: "Espelette", varName: "--red", hex: "#b23a1e" },
  { name: "Clay", varName: "--gold", hex: "#a05e1c" },
];
      ...
      <Card title="Voice & tokens" icon={<IconRing><Ic.Quill size={15} /></IconRing>} hint="src/styles.css :root">
        ...
        <div className="lb-grid2" style={{ marginTop: 16 }}>
          ...
          <div className="lb-row lb-row--top">
            ...
            <div className="lb-wobble" style={{ borderStyle: "dashed", borderColor: "#d6dbe1" }}>dashed border<br />= editable / dropzone</div>
