...
const BUCKETS = [
  { key: "red" as const, label: "Direct contradiction", tone: "#b23a1e", severity: "update-required" },
  { key: "gold" as const, label: "Needs update", tone: "#a05e1c", severity: "review" },
  { key: "blue" as const, label: "Mentions", tone: "#1e6fa8", severity: "minor" },
];
    ...
    <aside className="lg-drawer" role="dialog" aria-label="Assert impact">
      ...
      <div className="lg-drawer__body">
        ...
        <div className="btn lg-assert-status">
          <Ic.CheckCircle size={15} style={{ color: analyzing ? "var(--gold, #a05e1c)" : analyzedAt ? "var(--green-deep)" : "var(--ink-faint)" } as any} />
          <span>
