...
Connection ownership lives in ``mari_server.persistence.postgres.connection``.  This
...
from mari_server.identity import context as access_module
from mari_server.identity.actor import SERVICE_ACTOR, actor_name, caller
...
def ensure_schema() -> None:
    ...
    from mari_server.persistence.postgres.schema import migrate
