...
import onboardingJourney from "../assets/illustrations/onboarding-journey.png";
      ...
      <section className="card welcome-card">
        {step === 0 && (
          <div className="welcome-hero">
            ...
            <figure className="welcome-hero__art">
              <img src={onboardingJourney} alt="Hand-drawn notebook journey from scattered source notes, through tagging and editing, to a connected knowledge graph and finished guide" />
              <figcaption>Your sources → your standards → shared, trusted knowledge</figcaption>
            </figure>
          </div>
        )}
