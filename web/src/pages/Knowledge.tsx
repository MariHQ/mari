                ...
                {rows.map((r) => (
                  ...
                  >
                    {r.icon ? (
                      ...
                      <input type="checkbox" checked={r.active} onChange={r.onToggle} style={{ accentColor: "#5c7a4c" }} />
                    )}
                    {r.label}
          ...
          {sorted.map((r, i) => (
            ...
            >
              <div className="row" style={{ alignItems: "flex-start", gap: 14 }}>
                ...
                >
                  <Ic.Bookmark size={16} style={saved.has(r.id) ? { fill: "#b04e2c", color: "#b04e2c" } : undefined} />
                </Button>
              </div>
            </Card>
          ))}
