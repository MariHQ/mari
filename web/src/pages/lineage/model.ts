...
export const REL = {
  references: { color: "#35549d", dash: undefined, label: "References" },
  discussed: { color: "#bf4f2e", dash: undefined, label: "Discussed in" },
  derived: { color: "#43663c", dash: undefined, label: "Derived from" },
  translates: { color: "#6a5a9c", dash: "4 5", label: "Translates" },
  contradicts: { color: "#c8502e", dash: "6 5", label: "Contradicts" },
} as const;
